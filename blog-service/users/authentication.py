...
class JWTAuthentication(authentication.BaseAuthentication):
    ...
    def __init__(self, *args, **kwargs):
        self.jwks_client = jwt.PyJWKClient(settings.USER_SERVICE_JWKS_URL, cache_keys=True)
    ...
    def authenticate(self, request: HttpRequest):
        ...
        if not match:
            raise exceptions.AuthenticationFailed("Authorization header must be of the following format: 'Bearer <jwt_token>'")
