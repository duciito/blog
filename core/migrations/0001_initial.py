    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followed_users', models.ManyToManyField(blank=True, related_name='followers', to='core.BlogUser')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment', to='core.bloguser')),
                ('voters', models.ManyToManyField(blank=True, related_name='liked_comments', to='core.BlogUser')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='article',
            name='creator',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='article', to='core.bloguser'),
        ),
        migrations.AddField(
            model_name='article',
            name='voters',
            field=models.ManyToManyField(blank=True, related_name='liked_articles', to='core.BlogUser'),
        ),
    ]
