...
class UsersViewSet(viewsets.ReadOnlyModelViewSet, FollowableContentMixin):
    ...
    def followed_users(self, request, pk=None):
        ...
        followed_users = serializer(
            user.followed_users, many=True, context={"request": request}
        )
    ...
    def saved_articles(self, request, pk=None):
        ...
        if request.user.id == int(pk):
            ...
            saved_articles = LightArticleSerializer(
                user.saved_articles, many=True, context={"request": request}
            )
    ...
    def popular(self, request):
        ...
        result = serializer(queryset, many=True, context={"request": request})
